/* DEPRECATED - GlitterBelts now have CompHealBelt, CompRepairBelt, and CompSuppressBleeding
using System;
...
namespace D9CTM
{
    //just a Ranged Shield Belt - Repair Belt combo used for the endgame item
    [StaticConstructorOnStartup]
    public class GlitterBelt : RangedShieldBelt
    {
